...
class Intl {
	...
	public function currency($type, $search = '') {
	    ...
	    $symbol = array_search($search, $currency_symbols, true);
	  	if ($symbol) {
	       ...
	       $symbol = $this->currency(3, $currency_symbols[$search]);
	       $symbol_key = $this->currency(2, $symbol);
	  	} else {
	    ...
	    $symbol_title = ucwords($symbol_key); 
	  	...
	  	if($type == 1) {
	        ...
	        foreach($currency_symbols as $key => $name) {
		        ...
		        $rows .= '<option value="'.$name.'"'.$selected.'>'.$symbol_title.'</option>';
	      	}
	      	return $rows;
	  	} elseif($type == 2) {
	        foreach($currency_symbols as $key => $name) {
	...
	public function icon($type, $ic = '') {
	      ...
	      if ($icon) {
	           ...
	           $icon = icon(3, $all_icons[$ic]);
	           $icon_key = icon(2, $icon);
	      } else {
	      ...
	      if($type == 1) {
	            ...
	            $rows .= '<option value="'.$name.'"'.$selected.'>'.$icon_title.'</option>';
	          }
	          return $rows;
	      } elseif($type == 2) {
	            foreach($all_icons as $key => $name) {
