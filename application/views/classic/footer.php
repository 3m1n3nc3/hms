    <div class="footer">
      <div class="footer-inner">
        <div class="container">
          <div class="row">
            <div class="span12"> 
              &copy; <?= date('Y')?> <a href="http://hotel.cihadoge.com/"> <?= HOTEL_NAME?></a>. 
              <span class="pull-right">          
                <span style="margin-right: 15px;"> 
                  <a href="<?= site_url($this->uri->uri_string().'?set_theme='.($this->h_theme == 'classic' ? 'modern' : 'classic'))?>" class="text-danger">
                    Switch Theme to <?=($this->h_theme == 'classic' ? 'modern' : 'classic')?>
                  </a> 
                  <span class="text-info"> (<?=ucwords($this->h_theme)?>)</span> 
                </span>
                Hoolicontech
              </span> 
            </div>
    ...
    <script src="<?php echo base_url('backend/js/jquery-1.7.2.min.js'); ?>"></script> 
    <script src="<?php echo base_url('backend/js/excanvas.min.js'); ?>"></script> 
    <script src="<?php echo base_url('backend/js/chart.min.js'); ?>" type="text/javascript"></script> 
    <script src="<?php echo base_url('backend/js/bootstrap.js'); ?>"></script>
    <script language="javascript" type="text/javascript" src="<?php echo base_url('backend/js/full-calendar/fullcalendar.min.js'); ?>"></script>
     
    <script src="<?php echo base_url('backend/js/base.js'); ?>"></script> 
