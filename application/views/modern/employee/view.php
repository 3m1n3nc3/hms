							...
							<div class="tab-pane<?= $this->input->post('update_profile') || $this->session->flashdata('update_profile') ? ' active' : ''?>" id="settings">
								<?= form_open('employee/profile/'.$employee['employee_id'])?> 
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" id="firstname" name="employee_firstname" class="form-control" value="<?= $employee['employee_firstname'] ?>" required>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" id="lastname" name="employee_lastname" class="form-control" value="<?= $employee['employee_lastname'] ?>" required>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
					                    	<input type="text" id="email" name="employee_email" class="form-control" value="<?= $employee['employee_email'] ?>">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
					                    	<input type="text" id="telephone" name="employee_telephone" class="form-control" value="<?= $employee['employee_telephone'] ?>" required>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
				                            <textarea id="address" name="employee_address" class="form-control"><?= $employee['employee_address'] ?></textarea>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
					                    	<input type="text" id="city" name="employee_city" class="form-control" value="<?= $employee['employee_city'] ?>" required>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
					                    	<input type="text" id="state" name="employee_state" class="form-control" value="<?= $employee['employee_state'] ?>" required>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
					                    	<input type="text" id="country" name="employee_country" class="form-control" value="<?= $employee['employee_country'] ?>" required>
