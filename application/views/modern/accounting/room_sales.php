        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12"> 
                ...
                <div class="col-lg-12">
                    ...
                    <?= form_open('accounting/cashier/room_sales'.$filter_query, array('class' => 'my-2'))?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="m-0 p-0">
                                <i class="fa fa-coins mx-2 text-gray"></i>
                                <?=lang('room_sale')?>
                            </strong>
                        ...
                        <div class="card-footer">
                            <span class="mr-5">
                                ...
                                <?=$this->cr_symbol.number_format($room_sales[0]['total'], 2)?>
                            </span>
                            <span class="mr-5">
                                <strong class="p-0"> 
                                    <?=lang('total_entries')?>: 
                                </strong> 
                                <?=$room_sales[0]['entries']?>
                            </span>
                        </div>
                        <?php endif;?>
                    </div>
